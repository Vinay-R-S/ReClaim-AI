                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="bg-gray-50 border-b border-gray-100">
                                    <th className="text-left py-3 px-4 text-sm font-medium text-text-secondary">Lost Item</th>
                                    <th className="text-left py-3 px-4 text-sm font-medium text-text-secondary">Found Item</th>
                                        ...
                                        <tr key={match.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="py-3 px-4 text-sm text-text-secondary">
                                                {(() => {
                                                    ...
                                                    const ts = match.createdAt as { _seconds?: number; seconds?: number };
