...
export function AdminSettings() {
  ...
  useEffect(() => {
    ...
    if (settings.mapCenter) {
      markerRef.current = L.marker([settings.mapCenter.lat, settings.mapCenter.lng], {
        icon: defaultIcon,
      }).addTo(mapRef.current);
    }
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-text-secondary mt-1">Configure system-wide settings for ReClaim AI</p>
      </div>
      ...
      <div className="bg-surface rounded-xl border border-border p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-lg font-medium text-text-primary">Heatmap Center Point</h2>
        ...
        <div className="space-y-4">
          ...
          {settings.mapCenter && (
            <div className="bg-green-50 rounded-lg p-3 text-sm">
              ...
              <p className="text-green-700 mt-1">{settings.mapCenter.address}</p>
      ...
      <div className="bg-surface rounded-xl border border-border p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-lg font-medium text-text-primary">Feature Toggles</h2>
            <p className="text-sm text-text-secondary">Enable or disable optional features</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4 rounded-lg border border-border">
            <div className="flex-1">
              <h3 className="font-medium text-text-primary">CCTV Intelligence</h3>
              <p className="text-sm text-text-secondary mt-1">
                AI-powered object detection using webcam or video uploads. Requires the ML models
            ...
            <div className="flex items-center gap-3 ml-4">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(e) => setSettings({ ...settings, cctvEnabled: e.target.checked })}
          ...
          <div className="flex items-center justify-between p-4 rounded-lg border border-border">
            <div className="flex-1">
              ...
              <p className="text-sm text-text-secondary mt-1">
                Switch between Dev mode (unlimited) and Testing mode (400 API calls/day limit).
              </p>
            ...
            <div className="flex items-center gap-3 ml-4">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(e) => setSettings({ ...settings, testingMode: e.target.checked })}
                  className="sr-only peer"
                />
      ...
      <div className="bg-surface rounded-xl border border-border p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-lg font-medium text-text-primary">Site Analytics</h2>
            <p className="text-sm text-text-secondary">Track visitor statistics (admin only)</p>
          </div>
        </div>

        <div className="flex items-center justify-between p-4 rounded-lg bg-indigo-50 border border-indigo-100">
          <div>
            <p className="text-sm text-indigo-600 font-medium">Total Visitors</p>
            <p className="text-3xl font-bold text-indigo-700 mt-1">
              {visitorCount.toLocaleString()}
            </p>
            <p className="text-xs text-indigo-500 mt-1">Unique visits tracked in Testing mode</p>
          </div>
          <button
            onClick={async () => {
      ...
      <div className="bg-surface rounded-xl border border-border p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-lg font-medium text-text-primary">AI Provider</h2>
            <p className="text-sm text-text-secondary">
