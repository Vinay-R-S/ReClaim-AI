      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-text-primary mb-2">Report Lost Item</h3>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-text-primary mb-2">Report Found Item</h3>
            <p className="text-sm text-text-secondary">
        ...
        <div className="card p-6 mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-text-secondary">Verify ownership and collect your item</p>
            </div>
          </div>
        </div>
